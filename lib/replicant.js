...
Proxy = function(wrapper, target, onEvent, namespace, addChild, removeChild) {
  var addChildPath, addToParent, ancestors, createMemberProxy, createProxyFor, getLocalFqn, notify, path, proxy, readHook, removeChildPath, removeFromParent, self, subject, walk;
  self = this;
  proxy = {};
