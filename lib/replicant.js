...
Proxy = function(wrapper, target, onEvent, namespace, addChild, removeChild) {
  ...
  this.splice = function() {
    var args, chgLen, i, len, newItems, stIdx, subjLen, value, _i, _ref, _results;
    ...
    stIdx = 0;
    while (i < len) {
      if (typeof newItems[i] === "ObjectWrapper" || typeof newItems[i] === "ArrayWrapper") {
    ...
    this.recrawl((function() {
      _results = [];
      for (var _i = stIdx, _ref = subject.length - 1; stIdx <= _ref ? _i <= _ref : _i >= _ref; stIdx <= _ref ? _i++ : _i--){ _results.push(_i); }
      return _results;
    }).apply(this));
