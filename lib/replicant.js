...
ArrayProxy = function(array, onGet, onSet, namespace, addChild, removeChild) {
  ...
  createIndex = function(proxy, key) {
    var fqn, original;
    original = subject[key];
    fqn = buildFqn(path, key);
    addToParent(fqn, proxy[key]);
    proxy[key] = onProxyOf(original, function() {
...
this.shift = function() {
  ...
  return _(array).chain().keys().each(function(key) {
...
ObjectProxy = function(subject, onGet, onSet, namespace, addChild, removeChild) {
  ...
  createProxyFor = function(writing, self, proxy, fqn, key, value) {
  ...
  return _(subject).chain().keys().each(function(key) {
...
replicant = {
  ...
  create: function(target, get, set, namespace) {
    this.onGet = get || (get = this["default"].onGet);
    this.onSet = set || (set = this["default"].onSet);
    this.namespace = namespace || (namespace = this["default"].namespace);
