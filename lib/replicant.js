  ...
  crawl = function(context, namespace, element) {
    ...
    if (element.children !== void 0 && element.children.length > 0) {
      ...
      return function(html, model, idx) {
        var call, controls, index, item, val;
        id = id === "" || id === void 0 ? idx : id;
        val = id === fqn ? model : model[id];
          ...
          controls = (function() {
            ...
            for (_i = 0, _len = val.length; _i < _len; _i++) {
              ...
              _results.push((function() {
                ...
                _results2 = [];
                for (_j = 0, _len2 = createChildren.length; _j < _len2; _j++) {
                  call = createChildren[_j];
                  _results2.push(call(html, val, index += 1));
                }
                return _results2;
              })());
            }
      ...
      return function(html, model, idx) {
        var item, val, x, _i, _len, _results;
        id = id === "" || id === void 0 ? idx : id;
        val = id === fqn ? model : model[id];
        x = 0;
        if (val instanceof ArrayProxy) {
