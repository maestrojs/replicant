...
Proxy = function(wrapper, target, onEvent, namespace, addChild, removeChild) {
  var addChildPath, addToParent, ancestors, createMemberProxy, createProxyFor, notify, path, proxy, removeChildPath, removeFromParent, subject, walk;
  proxy = {};
...
TemplateLibrary = function(root) {
  ...
  return {
    this.getTemplate: function(name, onLoad) {
