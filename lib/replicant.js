...
Cartographer = function(target, namespace) {
    ...
    if (element.children !== void 0 && element.children.length > 0) {
      ...
      return function(html, model, idx) {
        ...
        if (val instanceof ArrayProxy) {
          ...
          return makeTag(html, tag, actual, element, list, model);
        } else {
          controls = (function() {
            var _i, _len, _results;
            _results = [];
          ...
          return makeTag(html, tag, actual, element, controls, model);
        }
      };
    } else {
      return function(html, model, idx) {
        ...
        actual = id === "" ? idx : id;
        if (!actual) {
          return makeTag(html, tag, actual, element, val, model);
        } else {
          val = actual === fqn || actual === void 0 ? model : model[actual];
          x = 0;
          if (val === void 0) {
            if (actual === "" || actual === void 0) {
              return makeTag(html, tag, "", element, model, model);
            } else {
              return makeTag(html, tag, "", element, model, model);
            }
  ...
  makeTag = function(html, tag, id, template, val, model) {
    ...
    return html[tag](properties, val || properties.textContent);
  };
